...
/*---------------------------------------------------------------------------
 * Function: Col_MaxStringBufferLength
 *
...
size_t
Col_MaxStringBufferLength(Col_StringFormat format)
{
 ...
 *	number of cells, and won't exceed the maximum value given by
 ...
 *
 * Type checking:
 *	*strbuf* must be a valid string buffer.
 *
 * Result:
